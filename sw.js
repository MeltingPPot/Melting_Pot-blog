 ...
 * sw.js
 * ===========================================================
 * Copyright 2026 Example Site template contributors
...
// Keep repository URLs without a trailing slash redirectable.
...
function sendMessageToClientsAsync(msg) {
  ...
  // This keeps directory-style URLs consistent on GitHub Pages.
